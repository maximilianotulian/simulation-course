...
/**
 * La clase Generador contiene mÃ©todos para generar numeros aleatorios de distintas distribuciones.
 * @author Coppa David, Fernandez Ezequiel Enrique, Gutierrez Victor y MuÃ±oz Manuel
 */
    public Generador() {
    }
     ...
     * <p>La decision de que formula usar, la resuelve el mÃ©todo de forma aleatoria.
     ...
     * <p>En este mÃ©todo se usa la transformada inversa.
     *
     * @param media  La media M(x) que se desea de la distribucion.
     ...
     * <p>Este mÃ©todo sirve para llamar a Math.random().
     ...
     * Es decir se generarÃ¡ un numero aleatorio de distribucion uniforme mayor o igual que "a" y menor que "b".
     *
     ...
     * Se utilizarÃ­a en el caso de que uno quiera repetir la misma secuencia de numeros aleatorios.
